...
lista.insertAtBeggining(30);
lista.toString(); // Saída: 30 -> undefined
lista.insertAtBeggining(20);
lista.toString(); // Saída: 20 -> 30 -> undefined
lista.insertAtBeggining(10);
...
lista.toString(); // Saída: 10 -> 20 -> 30 -> 40 -> undefined
...
console.log("\n-----------------");
console.log('\x1b[34m%sz\x1b[0m', 'Procurando um valor:');
